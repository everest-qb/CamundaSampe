...
public class ApproveOrderController implements Serializable {
  ...
  @PostConstruct
  public void init(){
	  System.out.println("Conversation init");
  }

	@PreDestroy
	public void destory() {
		System.out.println("Conversation destory");
	}
  
  public OrderEntity getOrderEntity() {
	  System.out.println("orderId:"+businessProcess.getVariable("orderId")+"/"+
			  businessProcess.getCachedVariableMap().size());
	  System.out.println(businessProcess.isAssociated()+"  P/E/T:"+businessProcess.getProcessInstanceId()
	  +"/"+businessProcess.getExecutionId()+"/"+businessProcess.getTaskId());
  ...
  public void approval() throws IOException{
	  orderBusinessLogic.approval();
  }
  
  public void returnUser()  throws IOException{
	  orderBusinessLogic.returnUser();
  }
