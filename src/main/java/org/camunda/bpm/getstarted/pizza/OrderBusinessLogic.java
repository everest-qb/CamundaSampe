...
import sunspring.OvertimeGlobal;
...
public class OrderBusinessLogic {
  ...
  public void persistOrder(DelegateExecution delegateExecution) {
    ...
    System.out.println(businessProcess.isAssociated()+" VariableScopeKey:"+delegateExecution.getVariableScopeKey());
  }
  ...
  public String findUser(String emp){
	  if(emp==null || emp.isEmpty())
		  return "Demo";
	  return emp;
  }
  
  public void showProcessVariables(DelegateExecution delegateExecution){
	  Map<String, Object> variables = delegateExecution.getVariables();
	  System.out.println("----------");
	  for(String key:variables.keySet()){
		  System.out.println("KEY:"+key+" / Value:"+variables.get(key));
	  }
	  delegateExecution.setVariable("nextCondition", OvertimeGlobal.APPROVAL);
  }
  
  public void approval(){
	  try {
		  businessProcess.setVariable("nextCondition", OvertimeGlobal.APPROVAL);
	      taskForm.completeTask();
	    } catch (IOException e) {
	      throw new RuntimeException("Cannot complete task", e);
	    }
  ...
  public void returnUser(){
	  try {
		  businessProcess.setVariable("nextCondition", OvertimeGlobal.RETURN);
	      taskForm.completeTask();
	    } catch (IOException e) {	    
	      throw new RuntimeException("Cannot complete task", e);
	    }
  ...
  public int check(DelegateExecution delegateExecution){
	  return (Integer)delegateExecution.getVariable("nextCondition");  
  }
